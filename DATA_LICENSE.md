...
The seven interface SVG glyphs in `public/icons/henro-hub/` were reused from the Henro Hub repository. Their final public-license status must be confirmed during release preparation; this note does not assign them a new license.
